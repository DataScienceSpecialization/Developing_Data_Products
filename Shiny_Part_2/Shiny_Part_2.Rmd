...
We'll show you an example of how to use tabs to give you app
multiple views. The `tabsetPanel()` function speicifes a
...
without needing to have R or Shiny insatlled. Shinyapps.io
